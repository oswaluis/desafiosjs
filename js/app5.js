...
mostrarStock(stock)
	...
	function mostrarStock(array){
		...
		for( const producto of array){
			const {img, precio, nombre, tipo, talle, cantidad, id} = producto 
		let div = document.createElement("div")
			...
			div.innerHTML += `
			    		<div class=" card border-ligth me-3 mb-3 text-center h-100"  >
						     ...
						     <a id="botonCarr${id}" class="btn btn-primary">$${precio}</a>
						     </div>  
						</div>
			...
			let btnCarrito = document.getElementById(`botonCarr${id}`)
